...
from eTraveler.clientAPI.connection import Connection
# Optional. For more discerning exception handling
...
class yamlAssembly():
    ...
    def __init__(self, record):
        ...
        self._yaml['ShortDescription'] = "Assembly of " + self._name
    ...
    def registerHardwareType(self, name, rec):
        ...
        try: 
            ...
            print 'Name=', name
            print 'Description=', rec[7].value
        except Exception,msg:
            print "Registration of HardwareType %s failed"%name, "error message:", msg
    ...
    def addRelationship(self, gg):
        ...
        Register level 1 hardware type.
        ...
        sequence = self._yaml['Sequence'][relTaskPos]
...
try :
    ...
    print "with assembly template file ", assembly_template_file
...
for gg in gen:
    if gg[3].value == None:
        ...
        # it's END of FILE so we have to save the last d1 yaml flow.
        print "END OF FILE"
        d1.save()
        break
